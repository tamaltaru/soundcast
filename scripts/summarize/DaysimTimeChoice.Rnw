...
# Need to do: Trips by Purpose by Time
# Tours by Departure Time
@
...
Trip_deptm_graph + geom_histogram(binwidth = 1)+xlab("Trip Departure Time") + ylab("Percent of Trips")+facet_wrap("type")  +scale_x_continuous(breaks=number_ticks(10))
...
tour_deptm_graph <- ggplot(data=tours_by_time,
                           aes(x=Time, fill=type,weight=share))
tour_deptm_graph + geom_histogram(binwidth = 1)+xlab("tour destination arrival Time") + ylab("Percent of tours")+facet_wrap("type")
...
tour_deptm_graph_p <- ggplot(data=tours_by_time,
                           aes(x=Time, fill=type,weight=share))
tour_deptm_graph_p + geom_histogram(binwidth = 1)+xlab("tour destination arrival Time") + ylab("Percent of tours")+facet_wrap(c("type","purpose"))+scale_x_continuous(breaks=number_ticks(10))
